...
export const SETTINGS = [
  ...
  { key: 'singles', label: 'Show singles', type: 'switch', default: true,
    help: 'With a digit highlighted, a cell that is the only place left for it in its row, column or block gets a stronger colour. Hold such a cell to place the digit.' },
